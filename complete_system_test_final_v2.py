#!/usr/bin/env python
"""
Final System Test - Version 2 - Matches actual database schema
"""
...
def create_payment(session, traveler_id, batch_id):
    """Create a payment - simplified version without payment_method"""
    payment_data = {
...
def create_invoice(session, traveler_id, batch_id):
    """Create an invoice - using amount field (not base_amount)"""
    invoice_data = {
        "traveler_id": traveler_id,
        "batch_id": batch_id,
        "amount": 1000.00,
...
def main():
    print_header("🚀 FINAL SYSTEM TEST V2")
